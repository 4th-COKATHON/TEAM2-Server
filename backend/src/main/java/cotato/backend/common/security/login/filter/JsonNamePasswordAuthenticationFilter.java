package cotato.backend.common.security.login.filter;
...
@Slf4j
public class JsonNamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	public JsonNamePasswordAuthenticationFilter(ObjectMapper objectMapper) {
